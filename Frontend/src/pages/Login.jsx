...
const Login = () => {
  ...
  // Get the navigate function to redirect after successful login
  ...
  return (
    <div className="login-container min-h-screen bg-black flex items-center justify-center overflow-hidden relative">
      ...
      <div className="login-form relative z-10 w-full max-w-md mx-4">

        {/* Card with glowing border */}
        <div className="relative p-[1px] rounded-2xl bg-gradient-to-br from-cyan-400 via-fuchsia-500 to-violet-600 shadow-[0_0_60px_rgba(0,255,200,0.3),0_0_120px_rgba(200,0,255,0.2)]">
          <div className="bg-[#050510] rounded-2xl p-8 backdrop-blur-xl">
            ...
            {/* Header */}
            <h1 className="text-5xl font-black text-center mb-8 tracking-tighter bg-gradient-to-r from-cyan-300 via-fuchsia-300 to-violet-300 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(0,255,200,0.6)] font-[system-ui]">
              LOGIN
            </h1>
